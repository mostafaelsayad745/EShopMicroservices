...
internal class InitialData
{
	...
	public static IEnumerable<Order> OrdersWithItems
	{
		get
		{
			var address1 = Address.Of("mostafa", "ahmed", "mostafa@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
			var address2 = Address.Of("mohamed", "elsayad", "mohamed@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");
